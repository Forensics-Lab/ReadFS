...
class Import_Window(ctk.CTkToplevel):
    def __init__(self, master, slave, case_manage):
        ...
        # ENTRIES
        self.ctk_entry1 = ctk.CTkEntry(self, textvariable=self.default_import_path, width=319, font=("GOST Common", 17))
        ...
        self.import_dir_button.place(relx=0.9, rely=0.4, anchor="center")
    ...
    def import_btn_callback(self):
        self.case_manager.import_(self.ctk_entry1.get())
